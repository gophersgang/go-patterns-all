...
- [abcum/cachr](https://github.com/abcum/cachr) - A library of in-memory caching algorithms for Go <br/> ( 2017-03-20 / 26 commits / 0 stars )
- [abcum/lcp](https://github.com/abcum/lcp) - A longest common prefix library implementation for Go <br/> ( 2017-03-20 / 11 commits / 0 stars )
- [abcum/ptree](https://github.com/abcum/ptree) - A radix tree library implementation for Go <br/> ( 2017-04-26 / 18 commits / 0 stars )
...
- [arnauddri/algorithms](https://github.com/arnauddri/algorithms) - Algorithms & Data Structures in Go <br/> ( 2015-02-02 / 134 commits / 139 stars )
- [aurelien-rainone/go-rquad](https://github.com/aurelien-rainone/go-rquad) - State of the art point location and neighbour finding algorithms for region quadtrees, in Go <br/> ( 2017-05-17 / 262 commits / 1 stars )
...
- [codingsince1985/uva](https://github.com/codingsince1985/uva) - UVa Online Judge solutions in Go <br/> ( 2017-05-21 / 649 commits / 10 stars )
...
- [deckarep/golang-set](https://github.com/deckarep/golang-set) - A simple set type for the Go language. Also used in Docker. <br/> ( 2017-05-17 / 102 commits / 66 stars )
...
- [eapache/go-resiliency](https://github.com/eapache/go-resiliency) - Resiliency patterns for golang <br/> ( 2016-01-04 / 44 commits / 32 stars )
...
- [golang/sync](https://github.com/golang/sync) - [mirror] concurrency primitives <br/> ( 2017-05-17 / 17 commits / 9 stars )
...
- [imdario/mergo](https://github.com/imdario/mergo) - Mergo: merging Go structs and maps since 2013. <br/> ( 2017-03-26 / 74 commits / 57 stars )
...
- [kamranahmedse/design-patterns-for-humans](https://github.com/kamranahmedse/design-patterns-for-humans) - Design Patterns for Humans™ - An ultra-simplified explanation <br/> ( 2017-05-07 / 109 commits / 1,204 stars )
...
- [mmcgrana/gobyexample](https://github.com/mmcgrana/gobyexample) - Go by Example <br/> ( 2016-12-27 / 807 commits / 414 stars )
- [monochromegane/go_design_pattern](https://github.com/monochromegane/go_design_pattern) - Design patterns in Golang. <br/> ( 2015-07-09 / 36 commits / 97 stars )
- [moul/euler](https://github.com/moul/euler) - :game_die: Project Euler in Golang <br/> ( 2016-10-19 / 62 commits / 0 stars )
- [mrekucci/epi](https://github.com/mrekucci/epi) - Solutions for Elements of Programming Interviews problems written in Golang (work-in-progress) <br/> ( 2016-07-23 / 285 commits / 13 stars )
- [nanxiao/golang-101-hacks](https://github.com/nanxiao/golang-101-hacks) - A rudimentary Go tutorial. <br/> ( 2016-09-30 / 96 commits / 9 stars )
...
- [orcaman/concurrent-map](https://github.com/orcaman/concurrent-map) - a thread-safe concurrent map for go <br/> ( 2017-03-28 / 86 commits / 93 stars )
...
- [qkraudghgh/algorithms](https://github.com/qkraudghgh/algorithms) - Minimal examples of data structures and algorithms in Golang <br/> ( 2017-05-12 / 9 commits / 5 stars )
...
- [stefanschroeder/golang-regex-tutorial](https://github.com/stefanschroeder/golang-regex-tutorial) - Golang - Regular Expression Tutorial <br/> ( 2017-05-06 / 95 commits / 77 stars )
...
- [svett/golang-design-patterns](https://github.com/svett/golang-design-patterns) - A Gang of Gophers (originally Gang of Four) design patterns written in Golang <br/> ( 2016-05-15 / 22 commits / 9 stars )
- [thejerf/suture](https://github.com/thejerf/suture) - Supervisor trees for Go. <br/> ( 2017-03-03 / 32 commits / 25 stars )
- [timtadh/fs2](https://github.com/timtadh/fs2) - B+ Tree - List - File Structures 2 - Memory Mapped File Structures for Go <br/> ( 2016-08-04 / 193 commits / 12 stars )
...
- [tmrts/go-patterns](https://github.com/tmrts/go-patterns) - Curated list of Go design patterns, recipes and idioms <br/> ( 2017-05-01 / 71 commits / 186 stars )
...
- [workiva/go-datastructures](https://github.com/workiva/go-datastructures) - --- <br/> ( 2017-05-03 / 629 commits / 308 stars )
...
- [yksz/go-design-patterns](https://github.com/yksz/go-design-patterns) - Design patterns implemented with Golang <br/> ( 2014-06-07 / 38 commits / 13 stars )
- [zhenjl/encoding](https://github.com/zhenjl/encoding) - Integer Compression Libraries for Go <br/> ( 2014-09-05 / 71 commits / 9 stars )
- [zhenjl/ringbuffer](https://github.com/zhenjl/ringbuffer) - Disruptor style ring buffer in Go <br/> ( 2013-12-02 / 9 commits / 8 stars )
<!-- /PROJECTS_LIST -->

### By Activity
<!-- ACTIVITY_LIST -->
- [codingsince1985/uva](https://github.com/codingsince1985/uva): 2017-05-21 <br/> UVa Online Judge solutions in Go
- [golang/sync](https://github.com/golang/sync): 2017-05-17 <br/> [mirror] concurrency primitives
...
- [workiva/go-datastructures](https://github.com/workiva/go-datastructures): 2017-05-03 <br/> ---
- [dc0d/workerpool](https://github.com/dc0d/workerpool): 2017-05-03 <br/> A workerpool that can get expanded & shrink dynamically.
- [tmrts/go-patterns](https://github.com/tmrts/go-patterns): 2017-05-01 <br/> Curated list of Go design patterns, recipes and idioms
- [alexandergrom/go-patterns](https://github.com/alexandergrom/go-patterns): 2017-04-29 <br/> Design patterns in Golang
...
- [abcum/vtree](https://github.com/abcum/vtree): 2017-04-26 <br/> A versioned radix tree library implementation for Go
- [abcum/ptree](https://github.com/abcum/ptree): 2017-04-26 <br/> A radix tree library implementation for Go
- [abcum/tlist](https://github.com/abcum/tlist): 2017-04-26 <br/> A linked time series list implementation for Go
...
- [vladimirvivien/learning-go](https://github.com/vladimirvivien/learning-go): 2017-03-29 <br/> Source code repository for book "Learning Go Programming"
- [orcaman/concurrent-map](https://github.com/orcaman/concurrent-map): 2017-03-28 <br/> a thread-safe concurrent map for go
- [imdario/mergo](https://github.com/imdario/mergo): 2017-03-26 <br/> Mergo: merging Go structs and maps since 2013.
- [serdmanczyk/bifrost](https://github.com/serdmanczyk/bifrost): 2017-03-24 <br/> Golang query-able job queue
...
- [abcum/lcp](https://github.com/abcum/lcp): 2017-03-20 <br/> A longest common prefix library implementation for Go
...
- [codingsince1985/checksum](https://github.com/codingsince1985/checksum): 2017-03-04 <br/> Message digest for large files in Go
...
- [glycerine/idem](https://github.com/glycerine/idem): 2017-02-05 <br/> idem.Halter: a pattern for halting goroutines in Go
...
- [workiva/go-datastructures](https://github.com/workiva/go-datastructures): 9.22 MB<br/>  (8.44 MB git / 0.78 MB code)
...
- [codingsince1985/uva](https://github.com/codingsince1985/uva): 3.77 MB<br/>  (1.80 MB git / 1.96 MB code)
- [exercism/xgo](https://github.com/exercism/xgo): 2.75 MB<br/>  (2.07 MB git / 0.68 MB code)
- [aurelien-rainone/go-rquad](https://github.com/aurelien-rainone/go-rquad): 2.01 MB<br/>  (1.46 MB git / 0.55 MB code)
...
- [emirpasic/gods](https://github.com/emirpasic/gods): 0.98 MB<br/>  (0.54 MB git / 0.44 MB code)
...
- [deckarep/golang-set](https://github.com/deckarep/golang-set): 0.30 MB<br/>  (0.24 MB git / 0.07 MB code)
- [alexandergrom/componenta](https://github.com/alexandergrom/componenta): 0.28 MB<br/>  (0.11 MB git / 0.17 MB code)
...
- [kamranahmedse/design-patterns-for-humans](https://github.com/kamranahmedse/design-patterns-for-humans): 0.20 MB<br/>  (0.13 MB git / 0.06 MB code)
...
- [joernweissenborn/eventual2go](https://github.com/joernweissenborn/eventual2go): 0.18 MB<br/>  (0.10 MB git / 0.08 MB code)
...
- [mailgun/holster](https://github.com/mailgun/holster): 0.14 MB<br/>  (0.06 MB git / 0.08 MB code)
...
- [imdario/mergo](https://github.com/imdario/mergo): 0.12 MB<br/>  (0.09 MB git / 0.03 MB code)
...
- [abcum/ptree](https://github.com/abcum/ptree): 0.11 MB<br/>  (0.06 MB git / 0.05 MB code)
...
- [orcaman/concurrent-map](https://github.com/orcaman/concurrent-map): 0.11 MB<br/>  (0.08 MB git / 0.02 MB code)
...
- [vladimirvivien/go-cshared-examples](https://github.com/vladimirvivien/go-cshared-examples): 0.10 MB<br/>  (0.06 MB git / 0.03 MB code)
- [go-cmd/cmd](https://github.com/go-cmd/cmd): 0.09 MB<br/>  (0.05 MB git / 0.04 MB code)
- [sunfmin/fanout](https://github.com/sunfmin/fanout): 0.09 MB<br/>  (0.07 MB git / 0.02 MB code)
- [serdmanczyk/bifrost](https://github.com/serdmanczyk/bifrost): 0.09 MB<br/>  (0.06 MB git / 0.03 MB code)
- [eapache/go-resiliency](https://github.com/eapache/go-resiliency): 0.09 MB<br/>  (0.06 MB git / 0.03 MB code)
- [abcum/vtree](https://github.com/abcum/vtree): 0.09 MB<br/>  (0.04 MB git / 0.04 MB code)
...
- [mitghi/buffpool](https://github.com/mitghi/buffpool): 0.08 MB<br/>  (0.06 MB git / 0.02 MB code)
- [abcum/tlist](https://github.com/abcum/tlist): 0.08 MB<br/>  (0.05 MB git / 0.04 MB code)
- [streadway/quantile](https://github.com/streadway/quantile): 0.08 MB<br/>  (0.07 MB git / 0.01 MB code)
- [serialx/hashring](https://github.com/serialx/hashring): 0.08 MB<br/>  (0.06 MB git / 0.02 MB code)

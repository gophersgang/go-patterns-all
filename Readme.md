...
- [abcum/ptree](https://github.com/abcum/ptree) - A radix tree library implementation for Go <br/> ( 2017-03-20 / 17 commits / 0 stars )
- [abcum/tlist](https://github.com/abcum/tlist) - A time series list implementation for Go <br/> ( 2017-03-20 / 37 commits / 0 stars )
- [abcum/vtree](https://github.com/abcum/vtree) - A versioned radix tree library implementation for Go <br/> ( 2017-03-20 / 14 commits / 0 stars )
- [akresling/jono](https://github.com/akresling/jono) - A self adjusting worker pool <br/> ( 2017-01-06 / 2 commits / 0 stars )
- [alexandergrom/componenta](https://github.com/alexandergrom/componenta) - Go наброски <br/> ( 2017-04-05 / 21 commits / 1 stars )
- [alexandergrom/go-patterns](https://github.com/alexandergrom/go-patterns) - Design patterns in Golang <br/> ( 2017-03-07 / 20 commits / 22 stars )
- [alioygur/is](https://github.com/alioygur/is) - Micro check library in Golang. <br/> ( 2017-02-13 / 24 commits / 6 stars )
- [arnauddri/algorithms](https://github.com/arnauddri/algorithms) - Algorithms & Data Structures in Go <br/> ( 2015-02-02 / 134 commits / 135 stars )
- [bsm/histogram](https://github.com/bsm/histogram) - Streamining histograms in Go <br/> ( 2017-02-20 / 4 commits / 0 stars )
- [clarkduvall/hyperloglog](https://github.com/clarkduvall/hyperloglog) - HyperLogLog and HyperLogLog++ implementation in Go/Golang. <br/> ( 2016-12-12 / 34 commits / 30 stars )
...
- [dgryski/go-perfbook](https://github.com/dgryski/go-perfbook) - Thoughts on Go performance optimization <br/> ( 2017-04-24 / 27 commits / 12 stars )
...
- [golang/sync](https://github.com/golang/sync) - [mirror] concurrency primitives <br/> ( 2017-04-18 / 14 commits / 8 stars )
...
- [imdario/mergo](https://github.com/imdario/mergo) - Mergo: merging Go structs and maps since 2013. <br/> ( 2017-03-26 / 74 commits / 56 stars )
...
- [kamranahmedse/design-patterns-for-humans](https://github.com/kamranahmedse/design-patterns-for-humans) - Design Patterns for Humans™ - An ultra-simplified explanation <br/> ( 2017-04-21 / 107 commits / 1,143 stars )
...
- [mailgun/holster](https://github.com/mailgun/holster) - A place to keep useful golang functions and small libraries <br/> ( 2017-04-12 / 16 commits / 0 stars )
...
- [mmcgrana/gobyexample](https://github.com/mmcgrana/gobyexample) - Go by Example <br/> ( 2016-12-27 / 807 commits / 406 stars )
- [monochromegane/go_design_pattern](https://github.com/monochromegane/go_design_pattern) - Design patterns in Golang. <br/> ( 2015-07-09 / 36 commits / 93 stars )
...
- [orcaman/concurrent-map](https://github.com/orcaman/concurrent-map) - a thread-safe concurrent map for go <br/> ( 2017-03-28 / 86 commits / 87 stars )
...
- [rubyist/circuitbreaker](https://github.com/rubyist/circuitbreaker) - Circuit Breakers in Go <br/> ( 2017-03-30 / 113 commits / 35 stars )
...
- [stefanschroeder/golang-regex-tutorial](https://github.com/stefanschroeder/golang-regex-tutorial) - Golang - Regular Expression Tutorial <br/> ( 2016-11-27 / 89 commits / 73 stars )
...
- [svett/golang-design-patterns](https://github.com/svett/golang-design-patterns) - A Gang of Gophers (originally Gang of Four) design patterns written in Golang <br/> ( 2016-05-15 / 22 commits / 8 stars )
- [thejerf/suture](https://github.com/thejerf/suture) - Supervisor trees for Go. <br/> ( 2017-03-03 / 32 commits / 24 stars )
...
- [tmrts/go-patterns](https://github.com/tmrts/go-patterns) - Curated list of Go design patterns, recipes and idioms <br/> ( 2017-03-08 / 69 commits / 173 stars )
- [tsenart/tb](https://github.com/tsenart/tb) - A generic lock-free implementation of the "Token-Bucket" algorithm <br/> ( 2015-12-08 / 62 commits / 13 stars )
...
- [workiva/go-datastructures](https://github.com/workiva/go-datastructures) - --- <br/> ( 2017-03-31 / 623 commits / 299 stars )
...
- [zhenjl/encoding](https://github.com/zhenjl/encoding) - Integer Compression Libraries for Go <br/> ( 2014-09-05 / 71 commits / 10 stars )
- [zhenjl/ringbuffer](https://github.com/zhenjl/ringbuffer) - Disruptor style ring buffer in Go <br/> ( 2013-12-02 / 9 commits / 8 stars )
<!-- /PROJECTS_LIST -->

### By Activity
<!-- ACTIVITY_LIST -->
- [dgryski/go-perfbook](https://github.com/dgryski/go-perfbook): 2017-04-24 <br/> Thoughts on Go performance optimization
- [codingsince1985/uva](https://github.com/codingsince1985/uva): 2017-04-23 <br/> UVa Online Judge solutions in Go
- [exercism/xgo](https://github.com/exercism/xgo): 2017-04-23 <br/> Exercism Exercises in Go
- [kamranahmedse/design-patterns-for-humans](https://github.com/kamranahmedse/design-patterns-for-humans): 2017-04-21 <br/> Design Patterns for Humans™ - An ultra-simplified explanation
...
- [golang/sync](https://github.com/golang/sync): 2017-04-18 <br/> [mirror] concurrency primitives
- [gophergala/go-algos](https://github.com/gophergala/go-algos): 2017-04-18 <br/> ---
- [mailgun/holster](https://github.com/mailgun/holster): 2017-04-12 <br/> A place to keep useful golang functions and small libraries
...
- [alexandergrom/componenta](https://github.com/alexandergrom/componenta): 2017-04-05 <br/> Go наброски
- [workiva/go-datastructures](https://github.com/workiva/go-datastructures): 2017-03-31 <br/> ---
...
- [abcum/vtree](https://github.com/abcum/vtree): 2017-03-20 <br/> A versioned radix tree library implementation for Go
- [abcum/tlist](https://github.com/abcum/tlist): 2017-03-20 <br/> A time series list implementation for Go
- [abcum/ptree](https://github.com/abcum/ptree): 2017-03-20 <br/> A radix tree library implementation for Go
...
- [codingsince1985/uva](https://github.com/codingsince1985/uva): 4.30 MB<br/>  (2.37 MB git / 1.93 MB code)
- [exercism/xgo](https://github.com/exercism/xgo): 2.84 MB<br/>  (2.17 MB git / 0.67 MB code)
...
- [kamranahmedse/design-patterns-for-humans](https://github.com/kamranahmedse/design-patterns-for-humans): 0.37 MB<br/>  (0.31 MB git / 0.06 MB code)
- [alexandergrom/componenta](https://github.com/alexandergrom/componenta): 0.29 MB<br/>  (0.13 MB git / 0.17 MB code)
- [deckarep/golang-set](https://github.com/deckarep/golang-set): 0.29 MB<br/>  (0.23 MB git / 0.06 MB code)
...
- [djherbis/buffer](https://github.com/djherbis/buffer): 0.22 MB<br/>  (0.17 MB git / 0.05 MB code)
...
- [rubyist/circuitbreaker](https://github.com/rubyist/circuitbreaker): 0.20 MB<br/>  (0.15 MB git / 0.05 MB code)
- [mailgun/holster](https://github.com/mailgun/holster): 0.19 MB<br/>  (0.11 MB git / 0.08 MB code)
- [ungerik/go-dry](https://github.com/ungerik/go-dry): 0.19 MB<br/>  (0.11 MB git / 0.08 MB code)
- [joernweissenborn/eventual2go](https://github.com/joernweissenborn/eventual2go): 0.18 MB<br/>  (0.11 MB git / 0.08 MB code)
...
- [imdario/mergo](https://github.com/imdario/mergo): 0.13 MB<br/>  (0.10 MB git / 0.03 MB code)
...
- [orcaman/concurrent-map](https://github.com/orcaman/concurrent-map): 0.11 MB<br/>  (0.09 MB git / 0.02 MB code)
...
- [abcum/cachr](https://github.com/abcum/cachr): 0.11 MB<br/>  (0.04 MB git / 0.06 MB code)
...
- [vladimirvivien/go-cshared-examples](https://github.com/vladimirvivien/go-cshared-examples): 0.10 MB<br/>  (0.07 MB git / 0.03 MB code)
...
- [dgryski/go-perfbook](https://github.com/dgryski/go-perfbook): 0.09 MB<br/>  (0.08 MB git / 0.01 MB code)
...
- [gitchander/bufqueue](https://github.com/gitchander/bufqueue): 0.05 MB<br/>  (0.03 MB git / 0.03 MB code)
